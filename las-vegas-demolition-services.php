...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation" id="servicespage">
	<!-- Loader -->
				...
				<div id="service-section" class="service-section container-fluid">
					...
					<div class="row">
						...
						<h2>Leave the Heavy Lifting and the Cleanup to the Pros at LVD</h2>
							...
							<p><strong>Las Vegas Demolition and Environmental Services, LLC.</strong><sup>&reg;</sup>, was created on the need to provide Nevada with safe, efficient and quality demolition services in a timely manner due to the mass population growth and increasing tourism. Brothers Joe and Sal Catania have been a force to be reckoned with in the Hotel and Casino demolition industry for over a decade. In addition, the Catania brother’s management team that makes up <abbr title="Las Vegas Demolition and Environmental Services, LLC.&reg;">LVD</abbr> has been working together on various projects for 15 years with a combined total of 86 years experience in the demolition abatement industry.</p>
							<p>Because a few of our casino implosions become public specticles, you have perhaps already seen our work (without knowing it)! Most recently, please view the famous <a href="https://www.youtube.com/watch?v=FEFHURDeJP0" target="_blank">Las Vegas Riviera Hotel &amp; Casino</a> implosion, the <a href="https://www.youtube.com/watch?v=Sfos-eHS7hQ" target="_blank">Palace Station Courtyard demolition</a> and the <a href="https://www.youtube.com/watch?v=wUmKptggGdU" target="_blank">Kinkhead Building tear down</a> in Carson City, Nevada. All of our work is 100% guaranteed.</p>
							<a href="contact-las-vegas-demolition.php" title="Contact Us Today" class="contact-button">Contact Us Today!</a>
						</div>
					</div>
				</div>
					...
					<footer id="footer" class="footer-main container-fluid no-padding row">
					  <a id="back-to-top" href="#back-to-top" class="back-to-top"><i class="fa fa-arrow-circle-o-up"></i></a>
						...
						<?php include_once('inc/twitter-carousel.php'); ?>
